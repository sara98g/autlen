...
pruebas/pr_afnd: pr_afnd.o afnd.o palabra.o alfabeto.o estado.o vectorIndice.o relacion.o
	$(CC) $(CFLAGS) -o pruebas/pr_afnd pr_afnd.o afnd.o palabra.o alfabeto.o estado.o vectorIndice.o relacion.o
...
valgrind_afnd:
	valgrind --leak-check=full ./pruebas/pr_afnd
